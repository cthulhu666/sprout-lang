...
[group('examples')]
compile-examples-stage1: (_compile-examples "build/compile_driver_bin_stage1" "examples/gfx/spinning_cube.sprout examples/gfx/character_view.sprout examples/gfx/character_animated.sprout examples/gfx/character_crowd.sprout examples/gfx/ecs_agents.sprout examples/gfx/ecs_flocking.sprout examples/gfx/terrain_demo.sprout examples/gfx/terrain_rivers_demo.sprout")
