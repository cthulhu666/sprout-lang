...
- [ ] `P0` End-to-end dynamic verification: `compile_driver_bin_stage1 --emit-ir` produces valid stage-2 IR for `compile_driver.sprout` without crashing or running out of memory. Stage-1 binary now built (1.52 MB; stage-0 IR emission: 749 MB peak RSS / 51s). Stage-2 self-compile was OOMing (exit 137, >4 GB) — `str_concat` GC leak now fixed (2026-05-08); verification pending.
