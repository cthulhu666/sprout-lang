...
@.str.11 = private unnamed_addr constant { i64, [6 x i8] } { i64 81930, [6 x i8] c"ready\00" }
...
@.str.52 = private unnamed_addr constant { i64, [7 x i8] } { i64 98314, [7 x i8] c" deg C\00" }
...
define i64 @__sprout_ir_eta___tc_ToString_Bool_to_string_27(i64 %env$, i64 %a0) {
entry:
  %ret = call i64 @__tc_ToString_Bool_to_string(i64 %a0)
  ret i64 %ret
}

define i64 @__sprout_ir_eta___tc_ToString_examples_existential_render_Temp_to_string_28(i64 %env$, i64 %a0) {
entry:
  %t$0 = alloca i64
  store i64 %a0, ptr %t$0
  %t$1 = call i64 @sprout_gc_push_i64_root(ptr %t$0)
...
entry:
  ...
  %t$1$raw = inttoptr i64 %t$1 to ptr
  store ptr @__sprout_ir_eta___tc_ToString_Int_to_string_25, ptr %t$1$raw
  %t$19 = alloca i64
  ...
  %t$21 = call i64 @sprout_gc_pop_roots(i64 1)
  %t$3 = getelementptr inbounds { i64, [6 x i8] }, ptr @.str.11, i64 0, i32 1, i64 0
  ...
  store ptr @__sprout_ir_eta___tc_ToString_String_to_string_26, ptr %t$5$raw
  %t$26 = alloca i64
  ...
  store ptr @__sprout_ir_eta___tc_ToString_Bool_to_string_27, ptr %t$8$raw
  %t$31 = alloca i64
  store i64 %t$8, ptr %t$31
  %t$32 = call i64 @sprout_gc_push_i64_root(ptr %t$31)
  ...
  store ptr @__sprout_ir_eta___tc_ToString_examples_existential_render_Temp_to_string_28, ptr %t$12$raw
  %t$38 = alloca i64
...
define i64 @__sprout_ir_lambda_29(i64 %env$, i64 %cell) {
entry:
  %t$2 = alloca i64
...
body_0_1:
  ...
  %t$8 = getelementptr inbounds { i64, [7 x i8] }, ptr @.str.52, i64 0, i32 1, i64 0
  %t$9 = ptrtoint ptr %t$8 to i64
  %t$14 = alloca i64
  store i64 %t$7, ptr %t$14
  %t$15 = call i64 @sprout_gc_push_i64_root(ptr %t$14)
