...
@.str.19 = private unnamed_addr constant { i64, [8 x i8] } { i64 114698, [8 x i8] c"Nothing\00" }
@.str.20 = private unnamed_addr constant { i64, [6 x i8] } { i64 81930, [6 x i8] c"Just(\00" }
...
@.str.24 = private unnamed_addr constant { i64, [4 x i8] } { i64 49162, [4 x i8] c"Ok(\00" }
@.str.25 = private unnamed_addr constant { i64, [2 x i8] } { i64 16394, [2 x i8] c")\00" }
@.str.26 = private unnamed_addr constant { i64, [5 x i8] } { i64 65546, [5 x i8] c"Err(\00" }
...
@.str.52 = private unnamed_addr constant { i64, [7 x i8] } { i64 98314, [7 x i8] c"circle\00" }
@.str.53 = private unnamed_addr constant { i64, [5 x i8] } { i64 65546, [5 x i8] c"rect\00" }
@.str.54 = private unnamed_addr constant { i64, [7 x i8] } { i64 98314, [7 x i8] c"square\00" }
...
body_0_1:
  ...
  %t$10 = getelementptr inbounds { i64, [3 x i8] }, ptr @.str.11, i64 0, i32 1, i64 0
...
define i64 @__sprout_ir_eta___tc_examples.existential_shapes.Shape_examples_existential_shapes_Circle_area_25(i64 %env$, i64 %a0) {
entry:
  %ret = call i64 @__tc_examples.existential_shapes.Shape_examples_existential_shapes_Circle_area(i64 %a0)
  ret i64 %ret
}

define i64 @__sprout_ir_eta___tc_examples.existential_shapes.Shape_examples_existential_shapes_Circle_name_26(i64 %env$, i64 %a0) {
entry:
  %ret = call i64 @__tc_examples.existential_shapes.Shape_examples_existential_shapes_Circle_name(i64 %a0)
  ret i64 %ret
}

define i64 @__sprout_ir_eta___tc_examples.existential_shapes.Shape_examples_existential_shapes_Rect_area_27(i64 %env$, i64 %a0) {
entry:
  %ret = call i64 @__tc_examples.existential_shapes.Shape_examples_existential_shapes_Rect_area(i64 %a0)
  ret i64 %ret
}

define i64 @__sprout_ir_eta___tc_examples.existential_shapes.Shape_examples_existential_shapes_Rect_name_28(i64 %env$, i64 %a0) {
entry:
  %ret = call i64 @__tc_examples.existential_shapes.Shape_examples_existential_shapes_Rect_name(i64 %a0)
  ret i64 %ret
}

define i64 @__sprout_ir_eta___tc_examples.existential_shapes.Shape_examples_existential_shapes_Square_area_29(i64 %env$, i64 %a0) {
entry:
  %ret = call i64 @__tc_examples.existential_shapes.Shape_examples_existential_shapes_Square_area(i64 %a0)
  ret i64 %ret
}

define i64 @__sprout_ir_eta___tc_examples.existential_shapes.Shape_examples_existential_shapes_Square_name_30(i64 %env$, i64 %a0) {
entry:
...
entry:
  ...
  store ptr @__sprout_ir_eta___tc_examples.existential_shapes.Shape_examples_existential_shapes_Circle_area_25, ptr %t$2$raw
  %t$22 = alloca i64
  store i64 %t$2, ptr %t$22
  %t$23 = call i64 @sprout_gc_push_i64_root(ptr %t$22)
  %t$3 = call i64 @sprout_alloc_closure(i64 8, i64 1)
  %t$3$raw = inttoptr i64 %t$3 to ptr
  store ptr @__sprout_ir_eta___tc_examples.existential_shapes.Shape_examples_existential_shapes_Circle_name_26, ptr %t$3$raw
  %t$24 = alloca i64
  ...
  store ptr @__sprout_ir_eta___tc_examples.existential_shapes.Shape_examples_existential_shapes_Rect_area_27, ptr %t$8$raw
  %t$31 = alloca i64
  store i64 %t$8, ptr %t$31
  %t$32 = call i64 @sprout_gc_push_i64_root(ptr %t$31)
  %t$9 = call i64 @sprout_alloc_closure(i64 8, i64 1)
  %t$9$raw = inttoptr i64 %t$9 to ptr
  store ptr @__sprout_ir_eta___tc_examples.existential_shapes.Shape_examples_existential_shapes_Rect_name_28, ptr %t$9$raw
  %t$33 = alloca i64
  ...
  store ptr @__sprout_ir_eta___tc_examples.existential_shapes.Shape_examples_existential_shapes_Square_area_29, ptr %t$13$raw
  %t$40 = alloca i64
  store i64 %t$13, ptr %t$40
  %t$41 = call i64 @sprout_gc_push_i64_root(ptr %t$40)
  %t$14 = call i64 @sprout_alloc_closure(i64 8, i64 1)
  %t$14$raw = inttoptr i64 %t$14 to ptr
  store ptr @__sprout_ir_eta___tc_examples.existential_shapes.Shape_examples_existential_shapes_Square_name_30, ptr %t$14$raw
  %t$42 = alloca i64
...
define i64 @__sprout_ir_lambda_31(i64 %env$, i64 %d) {
entry:
  %t$2 = alloca i64
  store i64 %d, ptr %t$2
  %t$3 = call i64 @sprout_gc_push_i64_root(ptr %t$2)
...
entry:
  ...
  %t$36 = call i64 @sprout_gc_pop_roots(i64 2)
  %t$11 = getelementptr inbounds { i64, [3 x i8] }, ptr @.str.16, i64 0, i32 1, i64 0
  %t$12 = ptrtoint ptr %t$11 to i64
  %t$37 = alloca i64
  ...
  %t$46 = call i64 @sprout_gc_pop_roots(i64 3)
  %t$17 = getelementptr inbounds { i64, [2 x i8] }, ptr @.str.17, i64 0, i32 1, i64 0
...
arm_0_1:
  ...
  br i1 %t$4, label %body_0_1, label %arm_1_1
body_0_1:
  %t$5 = getelementptr inbounds { i64, [8 x i8] }, ptr @.str.19, i64 0, i32 1, i64 0
  %t$6 = ptrtoint ptr %t$5 to i64
  br label %join_1
arm_1_1:
  %t$7 = add i64 0, 1
...
body_1_1:
  ...
  %t$10 = getelementptr inbounds { i64, [6 x i8] }, ptr @.str.20, i64 0, i32 1, i64 0
  %t$11 = ptrtoint ptr %t$10 to i64
  %t$17 = alloca i64
...
body_0_1:
  ...
  %t$6 = getelementptr inbounds { i64, [4 x i8] }, ptr @.str.24, i64 0, i32 1, i64 0
  %t$7 = ptrtoint ptr %t$6 to i64
  %t$23 = alloca i64
  ...
  %t$31 = call i64 @sprout_gc_pop_roots(i64 4)
  %t$10 = getelementptr inbounds { i64, [2 x i8] }, ptr @.str.25, i64 0, i32 1, i64 0
  %t$11 = ptrtoint ptr %t$10 to i64
  %t$32 = alloca i64
  store i64 %t$9, ptr %t$32
  %t$33 = call i64 @sprout_gc_push_i64_root(ptr %t$32)
...
body_1_1:
  ...
  %t$16 = getelementptr inbounds { i64, [5 x i8] }, ptr @.str.26, i64 0, i32 1, i64 0
  ...
  %t$20 = getelementptr inbounds { i64, [2 x i8] }, ptr @.str.27, i64 0, i32 1, i64 0
...
entry:
  ...
  %t$8 = getelementptr inbounds { i64, [2 x i8] }, ptr @.str.29, i64 0, i32 1, i64 0
...
entry:
  ...
  %t$5 = getelementptr inbounds { i64, [2 x i8] }, ptr @.str.31, i64 0, i32 1, i64 0
  %t$6 = ptrtoint ptr %t$5 to i64
  %t$20 = alloca i64
  store i64 %t$4, ptr %t$20
  %t$21 = call i64 @sprout_gc_push_i64_root(ptr %t$20)
...
arm_0_0:
  ...
  %t$3$gep = getelementptr i64, ptr %t$3$ptr, i64 1
  %t$3 = load i64, ptr %t$3$gep
  %t$4 = getelementptr inbounds { i64, [2 x i8] }, ptr @.str.34, i64 0, i32 1, i64 0
  %t$5 = ptrtoint ptr %t$4 to i64
  %t$16 = alloca i64
  ...
  %t$28 = call i64 @sprout_gc_pop_roots(i64 2)
  %t$8 = getelementptr inbounds { i64, [3 x i8] }, ptr @.str.35, i64 0, i32 1, i64 0
  %t$9 = ptrtoint ptr %t$8 to i64
  %t$29 = alloca i64
  store i64 %t$7, ptr %t$29
  %t$30 = call i64 @sprout_gc_push_i64_root(ptr %t$29)
  ...
  %t$13 = getelementptr inbounds { i64, [2 x i8] }, ptr @.str.36, i64 0, i32 1, i64 0
...
arm_0_0:
  ...
  %t$19 = getelementptr inbounds { i64, [2 x i8] }, ptr @.str.40, i64 0, i32 1, i64 0
...
arm_0_0:
  ...
  %t$9 = call i64 @__tc_Semigroup_String_append(i64 %t$7, i64 %t$8)
  %t$48 = call i64 @sprout_gc_pop_roots(i64 2)
  %t$10 = getelementptr inbounds { i64, [3 x i8] }, ptr @.str.42, i64 0, i32 1, i64 0
  %t$11 = ptrtoint ptr %t$10 to i64
  %t$49 = alloca i64
  ...
  %t$15 = getelementptr inbounds { i64, [3 x i8] }, ptr @.str.43, i64 0, i32 1, i64 0
  ...
  %t$20 = getelementptr inbounds { i64, [3 x i8] }, ptr @.str.44, i64 0, i32 1, i64 0
  %t$21 = ptrtoint ptr %t$20 to i64
  %t$69 = alloca i64
...
arm_0_0:
  ...
  %t$6$gep = getelementptr i64, ptr %t$6$ptr, i64 4
  %t$6 = load i64, ptr %t$6$gep
  %t$7 = getelementptr inbounds { i64, [2 x i8] }, ptr @.str.46, i64 0, i32 1, i64 0
  ...
  %t$58 = call i64 @sprout_gc_pop_roots(i64 2)
  %t$11 = getelementptr inbounds { i64, [3 x i8] }, ptr @.str.47, i64 0, i32 1, i64 0
  %t$12 = ptrtoint ptr %t$11 to i64
  %t$59 = alloca i64
  ...
  %t$68 = call i64 @sprout_gc_pop_roots(i64 2)
  %t$16 = getelementptr inbounds { i64, [3 x i8] }, ptr @.str.48, i64 0, i32 1, i64 0
  %t$17 = ptrtoint ptr %t$16 to i64
  %t$69 = alloca i64
  ...
  %t$21 = getelementptr inbounds { i64, [3 x i8] }, ptr @.str.49, i64 0, i32 1, i64 0
  %t$22 = ptrtoint ptr %t$21 to i64
  %t$79 = alloca i64
  ...
  %t$26 = getelementptr inbounds { i64, [3 x i8] }, ptr @.str.50, i64 0, i32 1, i64 0
  %t$27 = ptrtoint ptr %t$26 to i64
  %t$89 = alloca i64
  ...
  %t$31 = getelementptr inbounds { i64, [2 x i8] }, ptr @.str.51, i64 0, i32 1, i64 0
...
entry:
  %t$0 = getelementptr inbounds { i64, [7 x i8] }, ptr @.str.52, i64 0, i32 1, i64 0
  %t$1 = ptrtoint ptr %t$0 to i64
  ret i64 %t$1
}
...
entry:
  %t$0 = getelementptr inbounds { i64, [5 x i8] }, ptr @.str.53, i64 0, i32 1, i64 0
  %t$1 = ptrtoint ptr %t$0 to i64
  ret i64 %t$1
}
...
entry:
  %t$0 = getelementptr inbounds { i64, [7 x i8] }, ptr @.str.54, i64 0, i32 1, i64 0
  %t$1 = ptrtoint ptr %t$0 to i64
  ret i64 %t$1
}
