...
@.str.72 = private unnamed_addr constant { i64, [12 x i8] } { i64 180234, [12 x i8] c"do:io-maybe\00" }
@.str.73 = private unnamed_addr constant { i64, [20 x i8] } { i64 311306, [20 x i8] c"reading SPROUT_NAME\00" }
@.str.74 = private unnamed_addr constant { i64, [12 x i8] } { i64 180234, [12 x i8] c"SPROUT_NAME\00" }
...
entry:
  %t$0 = getelementptr inbounds { i64, [12 x i8] }, ptr @.str.72, i64 0, i32 1, i64 0
  %t$1 = ptrtoint ptr %t$0 to i64
  %t$2$ptr = inttoptr i64 %t$1 to ptr
  %t$2 = call i64 @print_str(ptr %t$2$ptr)
  %t$3 = getelementptr inbounds { i64, [20 x i8] }, ptr @.str.73, i64 0, i32 1, i64 0
  %t$4 = ptrtoint ptr %t$3 to i64
  %t$5$ptr = inttoptr i64 %t$4 to ptr
  %t$5 = call i64 @print_str(ptr %t$5$ptr)
  %t$6 = getelementptr inbounds { i64, [12 x i8] }, ptr @.str.74, i64 0, i32 1, i64 0
  %t$7 = ptrtoint ptr %t$6 to i64
  %t$8$st = call { i64, i64 } @stdlib.env.get_worker(i64 %t$7)
  %t$8 = extractvalue { i64, i64 } %t$8$st, 0
  %t$9 = extractvalue { i64, i64 } %t$8$st, 1
