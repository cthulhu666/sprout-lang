...
@.str.27 = private unnamed_addr constant { i64, [9 x i8] } { i64 131082, [9 x i8] c"matched=\00" }
@.str.28 = private unnamed_addr constant { i64, [9 x i8] } { i64 131082, [9 x i8] c"|prefix=\00" }
@.str.29 = private unnamed_addr constant { i64, [9 x i8] } { i64 131082, [9 x i8] c"|suffix=\00" }
@.str.30 = private unnamed_addr constant { i64, [11 x i8] } { i64 163850, [11 x i8] c"|replaced=\00" }
@.str.31 = private unnamed_addr constant { i64, [10 x i8] } { i64 147466, [10 x i8] c"|escaped=\00" }
@.str.32 = private unnamed_addr constant { i64, [5 x i8] } { i64 65546, [5 x i8] c"<ID>\00" }
@.str.33 = private unnamed_addr constant { i64, [15 x i8] } { i64 229386, [15 x i8] c"literal [A-Z]+\00" }
@.str.34 = private unnamed_addr constant { i64, [27 x i8] } { i64 425994, [27 x i8] c"regex matched but no range\00" }
@.str.35 = private unnamed_addr constant { i64, [12 x i8] } { i64 180234, [12 x i8] c"no id found\00" }
@.str.36 = private unnamed_addr constant { i64, [18 x i8] } { i64 278538, [18 x i8] c"[A-Z][A-Z]-[0-9]+\00" }
@.str.37 = private unnamed_addr constant { i64, [18 x i8] } { i64 278538, [18 x i8] c"invalid pattern: \00" }
@.str.38 = private unnamed_addr constant { i64, [22 x i8] } { i64 344074, [22 x i8] c"unsupported pattern: \00" }
@.str.39 = private unnamed_addr constant { i64, [52 x i8] } { i64 835594, [52 x i8] c"usage: sprout run examples/regex_demo.sprout <text>\00" }
...
@.str.83 = private unnamed_addr constant { i64, [28 x i8] } { i64 442378, [28 x i8] c"unsupported regex feature: \00" }
...
@.cname.13 = private unnamed_addr constant [33 x i8] c"stdlib.regex.RegexInvalidPattern\00"
@.cfkinds.13 = private unnamed_addr constant [2 x i8] c"s\00"
@.cname.14 = private unnamed_addr constant [37 x i8] c"stdlib.regex.RegexUnsupportedFeature\00"
@.cfkinds.14 = private unnamed_addr constant [2 x i8] c"s\00"
@.cname.15 = private unnamed_addr constant [19 x i8] c"stdlib.regex.Regex\00"
@.cfkinds.15 = private unnamed_addr constant [2 x i8] c"s\00"
@.cname.16 = private unnamed_addr constant [19 x i8] c"stdlib.regex.Match\00"
@.cfkinds.16 = private unnamed_addr constant [3 x i8] c"ii\00"
@.cname.17 = private unnamed_addr constant [29 x i8] c"stdlib.bytes.Utf8DecodeError\00"
...
else_2:
  ...
  %t$18 = call i64 @sprout_gc_push_i64_root(ptr %t$17)
  %t$6 = call i64 @sprout_alloc_obj(i64 13, i64 1)
  %t$6$ptr = inttoptr i64 %t$6 to ptr
  %t$6$f0 = getelementptr i64, ptr %t$6$ptr, i64 0
...
define i64 @stdlib.regex.match_from_range(i64 %range) {
entry:
  %t$3 = alloca i64
  store i64 %range, ptr %t$3
  %t$4 = call i64 @sprout_gc_push_i64_root(ptr %t$3)
  %t$0 = call i64 @int_range_start(i64 %range)
  %t$1 = call i64 @int_range_end(i64 %range)
  %t$5 = call i64 @sprout_gc_pop_roots(i64 1)
...
body_0_2:
  ...
  %t$16 = call i64 @sprout_gc_push_i64_root(ptr %t$15)
  %t$6 = call i64 @sprout_alloc_obj(i64 15, i64 1)
  %t$6$ptr = inttoptr i64 %t$6 to ptr
  %t$6$f0 = getelementptr i64, ptr %t$6$ptr, i64 0
...
entry:
  ...
  store i64 %t$0, ptr %t$14
  %t$15 = call i64 @sprout_gc_push_i64_root(ptr %t$14)
  %t$1$st = call { i64, i64 } @regex_find_range_unboxed(i64 %t$0, i64 %text)
  %t$1 = extractvalue { i64, i64 } %t$1$st, 0
  %t$2 = extractvalue { i64, i64 } %t$1$st, 1
...
body_0_3:
  ...
  store i64 %t$2, ptr %t$17
  %t$18 = call i64 @sprout_gc_push_i64_root(ptr %t$17)
  %t$7 = call i64 @stdlib.regex.match_from_range(i64 %t$2)
  %t$19 = call i64 @sprout_gc_pop_roots(i64 1)
  %t$20 = alloca i64
...
arm_2_3:
  ...
  unreachable
join_3:
  %t$4 = phi i64 [%t$8, %body_0_3], [%t$11, %body_1_3]
  ret i64 %t$4
}
...
entry:
  %t$0 = getelementptr inbounds { i64, [9 x i8] }, ptr @.str.27, i64 0, i32 1, i64 0
  %t$1 = ptrtoint ptr %t$0 to i64
  ...
  %t$36 = call i64 @sprout_gc_pop_roots(i64 2)
  %t$5 = getelementptr inbounds { i64, [9 x i8] }, ptr @.str.28, i64 0, i32 1, i64 0
  %t$6 = ptrtoint ptr %t$5 to i64
  %t$37 = alloca i64
  ...
  %t$11 = getelementptr inbounds { i64, [9 x i8] }, ptr @.str.29, i64 0, i32 1, i64 0
  %t$12 = ptrtoint ptr %t$11 to i64
  %t$47 = alloca i64
  ...
  %t$56 = call i64 @sprout_gc_pop_roots(i64 2)
  %t$18 = getelementptr inbounds { i64, [11 x i8] }, ptr @.str.30, i64 0, i32 1, i64 0
  %t$19 = ptrtoint ptr %t$18 to i64
  %t$57 = alloca i64
  ...
  %t$64 = call i64 @sprout_gc_pop_roots(i64 1)
  %t$22 = getelementptr inbounds { i64, [10 x i8] }, ptr @.str.31, i64 0, i32 1, i64 0
...
ntest_6:
  %t$10 = call i64 @sprout_field(i64 %t$6, i64 0)
  %t$11 = call i64 @sprout_field(i64 %t$6, i64 1)
  %t$12 = getelementptr inbounds { i64, [5 x i8] }, ptr @.str.32, i64 0, i32 1, i64 0
  %t$13 = ptrtoint ptr %t$12 to i64
  %t$34 = alloca i64
  ...
  %t$40 = call i64 @sprout_gc_pop_roots(i64 1)
  %t$15 = getelementptr inbounds { i64, [15 x i8] }, ptr @.str.33, i64 0, i32 1, i64 0
...
then_22:
  %t$24 = getelementptr inbounds { i64, [27 x i8] }, ptr @.str.34, i64 0, i32 1, i64 0
  %t$25 = ptrtoint ptr %t$24 to i64
  br label %join_22
else_22:
  %t$26 = getelementptr inbounds { i64, [12 x i8] }, ptr @.str.35, i64 0, i32 1, i64 0
  %t$27 = ptrtoint ptr %t$26 to i64
  br label %join_22
join_22:
...
entry:
  %t$0 = getelementptr inbounds { i64, [18 x i8] }, ptr @.str.36, i64 0, i32 1, i64 0
  %t$1 = ptrtoint ptr %t$0 to i64
  %t$26 = alloca i64
  store i64 %raw, ptr %t$26
  %t$27 = call i64 @sprout_gc_push_i64_root(ptr %t$26)
...
body_0_12:
  ...
  %t$17 = getelementptr inbounds { i64, [18 x i8] }, ptr @.str.37, i64 0, i32 1, i64 0
...
body_1_12:
  ...
  %t$23 = getelementptr inbounds { i64, [22 x i8] }, ptr @.str.38, i64 0, i32 1, i64 0
...
arm_0_3:
  ...
  br i1 %t$6, label %body_0_3, label %arm_1_3
body_0_3:
  %t$7 = getelementptr inbounds { i64, [52 x i8] }, ptr @.str.39, i64 0, i32 1, i64 0
...
entry:
  %t$0 = getelementptr inbounds { i64, [28 x i8] }, ptr @.str.83, i64 0, i32 1, i64 0
  %t$1 = ptrtoint ptr %t$0 to i64
...
entry:
  ...
  %cname_ptr_14 = getelementptr inbounds [37 x i8], ptr @.cname.14, i64 0, i64 0
  ...
  %cname_ptr_15 = getelementptr inbounds [19 x i8], ptr @.cname.15, i64 0, i64 0
  ...
  %cname_ptr_17 = getelementptr inbounds [29 x i8], ptr @.cname.17, i64 0, i64 0
