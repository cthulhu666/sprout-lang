...
entry:
  ...
  store i64 %t$2, ptr %t$10
  %t$11 = call i64 @sprout_gc_push_i64_root(ptr %t$10)
  %t$3 = call i64 @examples.http_echo_server.echo_text(i64 %p$req)
  %t$12 = alloca i64
...
define i64 @examples.http_echo_server.echo_text(i64 %p$req) {
entry:
  %t$10 = alloca i64
...
define i64 @__sprout_ir_eta_examples.http_echo_server.handle_9(i64 %p$env$, i64 %p$a0) {
entry:
  %t$0 = alloca i64
  store i64 %p$a0, ptr %t$0
  %t$1 = call i64 @sprout_gc_push_i64_root(ptr %t$0)
  %ret = call i64 @examples.http_echo_server.handle(i64 %p$a0)
  %t$2 = call i64 @sprout_gc_pop_roots(i64 1)
  ret i64 %ret
}
...
define i64 @__sprout_ir_eta_stdlib.http_server.as_server_error_10(i64 %p$env$, i64 %p$a0) {
entry:
  %t$0 = alloca i64
  store i64 %p$a0, ptr %t$0
  %t$1 = call i64 @sprout_gc_push_i64_root(ptr %t$0)
