...
@.str.60 = private unnamed_addr constant { i64, [13 x i8] } { i64 196618, [13 x i8] c"not-positive\00" }
...
entry:
  ...
  br i1 %t$1, label %divpanic_1, label %divok_1
divpanic_1:
  %t$2 = getelementptr inbounds { i64, [17 x i8] }, ptr @.str.58, i64 0, i32 1, i64 0
  %t$3 = ptrtoint ptr %t$2 to i64
  call i64 @panic(i64 %t$3)
  unreachable
divok_1:
...
divpanic_11:
  %t$12 = getelementptr inbounds { i64, [17 x i8] }, ptr @.str.59, i64 0, i32 1, i64 0
  %t$13 = ptrtoint ptr %t$12 to i64
...
then_3:
  ...
  ret { i64, i64 } %t$4$r1
else_3:
  %t$5 = getelementptr inbounds { i64, [13 x i8] }, ptr @.str.60, i64 0, i32 1, i64 0
  %t$6 = ptrtoint ptr %t$5 to i64
