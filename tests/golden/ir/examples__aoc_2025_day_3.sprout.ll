...
@.str.20 = private unnamed_addr constant { i64, [12 x i8] } { i64 180234, [12 x i8] c"read_file: \00" }
@.str.21 = private unnamed_addr constant { i64, [5 x i8] } { i64 65546, [5 x i8] c"true\00" }
@.str.22 = private unnamed_addr constant { i64, [6 x i8] } { i64 81930, [6 x i8] c"false\00" }
@.str.23 = private unnamed_addr constant { i64, [10 x i8] } { i64 147466, [10 x i8] c"IntRange(\00" }
...
@.str.27 = private unnamed_addr constant { i64, [8 x i8] } { i64 114698, [8 x i8] c"Nothing\00" }
@.str.28 = private unnamed_addr constant { i64, [6 x i8] } { i64 81930, [6 x i8] c"Just(\00" }
...
@.str.32 = private unnamed_addr constant { i64, [4 x i8] } { i64 49162, [4 x i8] c"Ok(\00" }
@.str.33 = private unnamed_addr constant { i64, [2 x i8] } { i64 16394, [2 x i8] c")\00" }
@.str.34 = private unnamed_addr constant { i64, [5 x i8] } { i64 65546, [5 x i8] c"Err(\00" }
...
@.str.61 = private unnamed_addr constant { i64, [11 x i8] } { i64 163850, [11 x i8] c"0123456789\00" }
...
entry:
  %t$10 = alloca i64
  store i64 %digits, ptr %t$10
  %t$11 = call i64 @sprout_gc_push_i64_root(ptr %t$10)
  %t$0 = call i64 @examples.aoc_2025_day_3.shrink_for_digit(i64 %digits, i64 %size, i64 %drops, i64 %digit)
  %t$12 = call i64 @sprout_gc_pop_roots(i64 1)
  br label %arm_0_1
arm_0_1:
  ...
  %t$18 = call i64 @sprout_gc_push_i64_root(ptr %t$17)
  %t$5 = call i64 @examples.aoc_2025_day_3.write_at_or_append(i64 %digits, i64 %t$3, i64 %digit)
  %t$6 = add i64 0, 1
  %t$7 = add i64 %t$3, %t$6
  %t$19 = alloca i64
...
entry:
  ...
  %t$2 = alloca i64
  store i64 %bank, ptr %t$2
  %t$3 = call i64 @sprout_gc_push_i64_root(ptr %t$2)
  %t$1 = call i64 @examples.aoc_2025_day_3.best_value_with_len(i64 %bank, i64 %t$0, i64 %count)
  %t$4 = call i64 @sprout_gc_pop_roots(i64 1)
  ret i64 %t$1
}
...
entry:
  ...
  %t$2 = add i64 0, 0
  %t$4 = alloca i64
  store i64 %banks, ptr %t$4
  %t$5 = call i64 @sprout_gc_push_i64_root(ptr %t$4)
  %t$3 = call i64 @examples.aoc_2025_day_3.sum_best_values(i64 %banks, i64 %t$1, i64 %t$0, i64 %count, i64 %t$2)
  %t$6 = call i64 @sprout_gc_pop_roots(i64 1)
  ret i64 %t$3
}
...
entry:
  ...
  br label %tco_loop
tco_loop:
  %lines = load i64, ptr %t$13
  %index = load i64, ptr %t$14
  %total = load i64, ptr %t$15
  %acc = load i64, ptr %t$16
  %t$0 = getelementptr inbounds { i64, [1 x i8] }, ptr @.str.18, i64 0, i32 1, i64 0
  %t$1 = ptrtoint ptr %t$0 to i64
  ...
  %t$26 = call i64 @sprout_gc_push_i64_root(ptr %t$25)
  %t$4 = call i64 @examples.aoc_2025_day_3.append_if_non_empty_bank(i64 %acc, i64 %t$3)
  %t$27 = call i64 @sprout_gc_pop_roots(i64 1)
  %t$5 = icmp sge i64 %index, %total
  %t$6 = zext i1 %t$5 to i64
...
entry:
  ...
  store i64 %t$0, ptr %t$5
  %t$6 = call i64 @sprout_gc_push_i64_root(ptr %t$5)
  %t$1 = call i64 @examples.aoc_2025_day_3.lines_to_banks_all(i64 %t$0)
  %t$7 = call i64 @sprout_gc_pop_roots(i64 1)
  ret i64 %t$1
}
...
arm_1_4:
  ...
  br i1 %t$10, label %body_1_4, label %arm_2_4
body_1_4:
  %t$11 = getelementptr inbounds { i64, [12 x i8] }, ptr @.str.20, i64 0, i32 1, i64 0
  %t$12 = ptrtoint ptr %t$11 to i64
  %t$21 = alloca i64
...
entry:
  %t$0 = add i64 0, 2
  %t$5 = alloca i64
  store i64 %banks, ptr %t$5
  %t$6 = call i64 @sprout_gc_push_i64_root(ptr %t$5)
  %t$1 = call i64 @examples.aoc_2025_day_3.sum_for_count(i64 %banks, i64 %t$0)
  %t$2 = add i64 0, 12
  %t$3 = call i64 @examples.aoc_2025_day_3.sum_for_count(i64 %banks, i64 %t$2)
  %t$7 = call i64 @sprout_gc_pop_roots(i64 1)
  %t$4 = call i64 @sprout_make2(i64 13, i64 %t$1, i64 %t$3)
  ret i64 %t$4
}
...
then_0:
  %t$2 = getelementptr inbounds { i64, [5 x i8] }, ptr @.str.21, i64 0, i32 1, i64 0
  %t$3 = ptrtoint ptr %t$2 to i64
  br label %join_0
else_0:
  %t$4 = getelementptr inbounds { i64, [6 x i8] }, ptr @.str.22, i64 0, i32 1, i64 0
...
entry:
  %t$0 = getelementptr inbounds { i64, [10 x i8] }, ptr @.str.23, i64 0, i32 1, i64 0
  %t$1 = ptrtoint ptr %t$0 to i64
  %t$14 = alloca i64
  ...
  %t$5 = getelementptr inbounds { i64, [3 x i8] }, ptr @.str.24, i64 0, i32 1, i64 0
  %t$6 = ptrtoint ptr %t$5 to i64
  %t$21 = alloca i64
  store i64 %t$4, ptr %t$21
  %t$22 = call i64 @sprout_gc_push_i64_root(ptr %t$21)
...
entry:
  %t$0 = getelementptr inbounds { i64, [1 x i8] }, ptr @.str.26, i64 0, i32 1, i64 0
  %t$1 = ptrtoint ptr %t$0 to i64
  ret i64 %t$1
}
...
arm_0_1:
  ...
  br i1 %t$4, label %body_0_1, label %arm_1_1
body_0_1:
  %t$5 = getelementptr inbounds { i64, [8 x i8] }, ptr @.str.27, i64 0, i32 1, i64 0
  %t$6 = ptrtoint ptr %t$5 to i64
  br label %join_1
arm_1_1:
  %t$7 = add i64 0, 1
...
body_1_1:
  ...
  %t$10 = getelementptr inbounds { i64, [6 x i8] }, ptr @.str.28, i64 0, i32 1, i64 0
  %t$11 = ptrtoint ptr %t$10 to i64
  %t$17 = alloca i64
...
body_0_1:
  ...
  %t$6 = getelementptr inbounds { i64, [4 x i8] }, ptr @.str.32, i64 0, i32 1, i64 0
  %t$7 = ptrtoint ptr %t$6 to i64
  %t$23 = alloca i64
...
body_1_1:
  ...
  %t$16 = getelementptr inbounds { i64, [5 x i8] }, ptr @.str.34, i64 0, i32 1, i64 0
...
entry:
  ...
  %t$8 = getelementptr inbounds { i64, [2 x i8] }, ptr @.str.37, i64 0, i32 1, i64 0
...
arm_0_0:
  ...
  %t$28 = call i64 @sprout_gc_pop_roots(i64 2)
  %t$8 = getelementptr inbounds { i64, [3 x i8] }, ptr @.str.43, i64 0, i32 1, i64 0
  %t$9 = ptrtoint ptr %t$8 to i64
  %t$29 = alloca i64
  ...
  %t$13 = getelementptr inbounds { i64, [2 x i8] }, ptr @.str.44, i64 0, i32 1, i64 0
...
arm_0_0:
  ...
  %t$38 = call i64 @sprout_gc_pop_roots(i64 2)
  %t$9 = getelementptr inbounds { i64, [3 x i8] }, ptr @.str.46, i64 0, i32 1, i64 0
  ...
  %t$13 = call i64 @__tc_Semigroup_String_append(i64 %t$11, i64 %t$12)
  %t$48 = call i64 @sprout_gc_pop_roots(i64 2)
  %t$14 = getelementptr inbounds { i64, [3 x i8] }, ptr @.str.47, i64 0, i32 1, i64 0
  %t$15 = ptrtoint ptr %t$14 to i64
  %t$49 = alloca i64
  ...
  %t$19 = getelementptr inbounds { i64, [2 x i8] }, ptr @.str.48, i64 0, i32 1, i64 0
...
arm_0_0:
  ...
  %t$9 = call i64 @__tc_Semigroup_String_append(i64 %t$7, i64 %t$8)
  %t$48 = call i64 @sprout_gc_pop_roots(i64 2)
  %t$10 = getelementptr inbounds { i64, [3 x i8] }, ptr @.str.50, i64 0, i32 1, i64 0
  %t$11 = ptrtoint ptr %t$10 to i64
  %t$49 = alloca i64
  ...
  %t$15 = getelementptr inbounds { i64, [3 x i8] }, ptr @.str.51, i64 0, i32 1, i64 0
  ...
  %t$20 = getelementptr inbounds { i64, [3 x i8] }, ptr @.str.52, i64 0, i32 1, i64 0
  %t$21 = ptrtoint ptr %t$20 to i64
  %t$69 = alloca i64
  ...
  %t$25 = getelementptr inbounds { i64, [2 x i8] }, ptr @.str.53, i64 0, i32 1, i64 0
...
arm_0_0:
  ...
  %t$6$gep = getelementptr i64, ptr %t$6$ptr, i64 4
  %t$6 = load i64, ptr %t$6$gep
  %t$7 = getelementptr inbounds { i64, [2 x i8] }, ptr @.str.54, i64 0, i32 1, i64 0
  ...
  %t$58 = call i64 @sprout_gc_pop_roots(i64 2)
  %t$11 = getelementptr inbounds { i64, [3 x i8] }, ptr @.str.55, i64 0, i32 1, i64 0
  %t$12 = ptrtoint ptr %t$11 to i64
  %t$59 = alloca i64
  ...
  %t$68 = call i64 @sprout_gc_pop_roots(i64 2)
  %t$16 = getelementptr inbounds { i64, [3 x i8] }, ptr @.str.56, i64 0, i32 1, i64 0
  %t$17 = ptrtoint ptr %t$16 to i64
  %t$69 = alloca i64
  ...
  %t$21 = getelementptr inbounds { i64, [3 x i8] }, ptr @.str.57, i64 0, i32 1, i64 0
  %t$22 = ptrtoint ptr %t$21 to i64
  %t$79 = alloca i64
  ...
  %t$26 = getelementptr inbounds { i64, [3 x i8] }, ptr @.str.58, i64 0, i32 1, i64 0
  %t$27 = ptrtoint ptr %t$26 to i64
  %t$89 = alloca i64
  ...
  %t$31 = getelementptr inbounds { i64, [2 x i8] }, ptr @.str.59, i64 0, i32 1, i64 0
...
entry:
  %t$0 = getelementptr inbounds { i64, [11 x i8] }, ptr @.str.61, i64 0, i32 1, i64 0
  %t$1 = ptrtoint ptr %t$0 to i64
  %t$6 = alloca i64
