...
@.str.28 = private unnamed_addr constant { i64, [13 x i8] } { i64 196618, [13 x i8] c"do:io-result\00" }
@.str.29 = private unnamed_addr constant { i64, [23 x i8] } { i64 360458, [23 x i8] c"capturing payload size\00" }
@.str.30 = private unnamed_addr constant { i64, [13 x i8] } { i64 196618, [13 x i8] c"io-do:bytes=\00" }
@.str.31 = private unnamed_addr constant { i64, [19 x i8] } { i64 294922, [19 x i8] c"io-do:crypto-error\00" }
...
@.str.72 = private unnamed_addr constant { i64, [13 x i8] } { i64 196618, [13 x i8] c"do:io-result\00" }
@.str.73 = private unnamed_addr constant { i64, [23 x i8] } { i64 360458, [23 x i8] c"capturing payload size\00" }
...
@.str.76 = private unnamed_addr constant { i64, [11 x i8] } { i64 163850, [11 x i8] c"0123456789\00" }
...
define i64 @stdlib.crypto.sha256(i64 %value) {
entry:
  %t$1 = alloca i64
  store i64 %value, ptr %t$1
  %t$2 = call i64 @sprout_gc_push_i64_root(ptr %t$1)
  %t$0 = call i64 @crypto_sha256(i64 %value)
  %t$3 = call i64 @sprout_gc_pop_roots(i64 1)
  ret i64 %t$0
}

define i64 @stdlib.crypto.hmac_sha256(i64 %key, i64 %message) {
entry:
  %t$1 = alloca i64
  store i64 %message, ptr %t$1
  %t$2 = call i64 @sprout_gc_push_i64_root(ptr %t$1)
  %t$3 = alloca i64
  store i64 %key, ptr %t$3
  %t$4 = call i64 @sprout_gc_push_i64_root(ptr %t$3)
  %t$0 = call i64 @crypto_hmac_sha256(i64 %key, i64 %message)
  %t$5 = call i64 @sprout_gc_pop_roots(i64 2)
  ret i64 %t$0
}

define i64 @stdlib.crypto.base64_encode(i64 %value) {
entry:
  %t$1 = alloca i64
  store i64 %value, ptr %t$1
  %t$2 = call i64 @sprout_gc_push_i64_root(ptr %t$1)
  %t$0 = call i64 @crypto_base64_encode(i64 %value)
  %t$3 = call i64 @sprout_gc_pop_roots(i64 1)
  ret i64 %t$0
}

define i64 @stdlib.crypto.base64_decode(i64 %raw) {
entry:
  %t$1 = alloca i64
  store i64 %raw, ptr %t$1
  %t$2 = call i64 @sprout_gc_push_i64_root(ptr %t$1)
  %t$0 = call i64 @crypto_base64_decode(i64 %raw)
  %t$3 = call i64 @sprout_gc_pop_roots(i64 1)
  ret i64 %t$0
}

define i64 @stdlib.crypto.bytes_xor(i64 %left, i64 %right) {
entry:
  %t$1 = alloca i64
  store i64 %right, ptr %t$1
  %t$2 = call i64 @sprout_gc_push_i64_root(ptr %t$1)
  ...
  store i64 %left, ptr %t$3
  %t$4 = call i64 @sprout_gc_push_i64_root(ptr %t$3)
  %t$0 = call i64 @crypto_bytes_xor(i64 %left, i64 %right)
  %t$5 = call i64 @sprout_gc_pop_roots(i64 2)
  ret i64 %t$0
}
...
entry:
  %t$0 = getelementptr inbounds { i64, [13 x i8] }, ptr @.str.28, i64 0, i32 1, i64 0
  %t$1 = ptrtoint ptr %t$0 to i64
  %t$2$ptr = inttoptr i64 %t$1 to ptr
  %t$2 = call i64 @print_str(ptr %t$2$ptr)
  %t$3 = getelementptr inbounds { i64, [23 x i8] }, ptr @.str.29, i64 0, i32 1, i64 0
  %t$4 = ptrtoint ptr %t$3 to i64
...
arm_0_2:
  ...
  br i1 %t$5, label %body_0_2, label %arm_1_2
body_0_2:
  %t$6 = getelementptr inbounds { i64, [13 x i8] }, ptr @.str.30, i64 0, i32 1, i64 0
...
arm_1_2:
  ...
  br i1 %t$12, label %body_1_2, label %arm_2_2
body_1_2:
  %t$13 = getelementptr inbounds { i64, [19 x i8] }, ptr @.str.31, i64 0, i32 1, i64 0
...
entry:
  %t$0 = getelementptr inbounds { i64, [13 x i8] }, ptr @.str.72, i64 0, i32 1, i64 0
  %t$1 = ptrtoint ptr %t$0 to i64
  %t$2$ptr = inttoptr i64 %t$1 to ptr
  %t$2 = call i64 @print_str(ptr %t$2$ptr)
  %t$3 = getelementptr inbounds { i64, [23 x i8] }, ptr @.str.73, i64 0, i32 1, i64 0
  %t$4 = ptrtoint ptr %t$3 to i64
  %t$5$ptr = inttoptr i64 %t$4 to ptr
  %t$5 = call i64 @print_str(ptr %t$5$ptr)
  %t$6 = add i64 0, 8
...
entry:
  %t$0 = getelementptr inbounds { i64, [11 x i8] }, ptr @.str.76, i64 0, i32 1, i64 0
  %t$1 = ptrtoint ptr %t$0 to i64
  %t$6 = alloca i64
...
entry:
  %t$0 = getelementptr inbounds { i64, [17 x i8] }, ptr @.str.77, i64 0, i32 1, i64 0
  %t$1 = ptrtoint ptr %t$0 to i64
  %t$25 = alloca i64
...
arm_1_5:
  ...
  br i1 %t$11, label %body_1_5, label %arm_2_5
body_1_5:
  %t$12 = getelementptr inbounds { i64, [17 x i8] }, ptr @.str.78, i64 0, i32 1, i64 0
  %t$13 = ptrtoint ptr %t$12 to i64
  %t$33 = alloca i64
  store i64 %t$13, ptr %t$33
  %t$34 = call i64 @sprout_gc_push_i64_root(ptr %t$33)
