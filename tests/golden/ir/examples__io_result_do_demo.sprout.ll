...
@.str.27 = private unnamed_addr constant { i64, [13 x i8] } { i64 196618, [13 x i8] c"do:io-result\00" }
@.str.28 = private unnamed_addr constant { i64, [23 x i8] } { i64 360458, [23 x i8] c"capturing payload size\00" }
@.str.29 = private unnamed_addr constant { i64, [13 x i8] } { i64 196618, [13 x i8] c"io-do:bytes=\00" }
@.str.30 = private unnamed_addr constant { i64, [19 x i8] } { i64 294922, [19 x i8] c"io-do:crypto-error\00" }
...
@.str.70 = private unnamed_addr constant { i64, [13 x i8] } { i64 196618, [13 x i8] c"do:io-result\00" }
@.str.71 = private unnamed_addr constant { i64, [23 x i8] } { i64 360458, [23 x i8] c"capturing payload size\00" }
...
@.cname.14 = private unnamed_addr constant [36 x i8] c"stdlib.crypto.CryptoInvalidArgument\00"
@.cfkinds.14 = private unnamed_addr constant [2 x i8] c"s\00"
@.cname.15 = private unnamed_addr constant [32 x i8] c"stdlib.crypto.CryptoUnavailable\00"
@.cfkinds.15 = private unnamed_addr constant [2 x i8] c"s\00"
@.cname.16 = private unnamed_addr constant [32 x i8] c"stdlib.crypto.Base64DecodeError\00"
@.cfkinds.16 = private unnamed_addr constant [2 x i8] c"s\00"
@.cname.17 = private unnamed_addr constant [37 x i8] c"stdlib.crypto.BytesXorLengthMismatch\00"
...
entry:
  %t$0 = getelementptr inbounds { i64, [13 x i8] }, ptr @.str.27, i64 0, i32 1, i64 0
  %t$1 = ptrtoint ptr %t$0 to i64
  %t$2$ptr = inttoptr i64 %t$1 to ptr
  %t$2 = call i64 @print_str(ptr %t$2$ptr)
  %t$3 = getelementptr inbounds { i64, [23 x i8] }, ptr @.str.28, i64 0, i32 1, i64 0
  %t$4 = ptrtoint ptr %t$3 to i64
...
arm_0_2:
  ...
  br i1 %t$5, label %body_0_2, label %arm_1_2
body_0_2:
  %t$6 = getelementptr inbounds { i64, [13 x i8] }, ptr @.str.29, i64 0, i32 1, i64 0
...
arm_1_2:
  ...
  br i1 %t$12, label %body_1_2, label %arm_2_2
body_1_2:
  %t$13 = getelementptr inbounds { i64, [19 x i8] }, ptr @.str.30, i64 0, i32 1, i64 0
...
entry:
  %t$0 = getelementptr inbounds { i64, [13 x i8] }, ptr @.str.70, i64 0, i32 1, i64 0
  %t$1 = ptrtoint ptr %t$0 to i64
  %t$2$ptr = inttoptr i64 %t$1 to ptr
  %t$2 = call i64 @print_str(ptr %t$2$ptr)
  %t$3 = getelementptr inbounds { i64, [23 x i8] }, ptr @.str.71, i64 0, i32 1, i64 0
  %t$4 = ptrtoint ptr %t$3 to i64
  %t$5$ptr = inttoptr i64 %t$4 to ptr
  %t$5 = call i64 @print_str(ptr %t$5$ptr)
  %t$6 = add i64 0, 8
...
entry:
  ...
  %cname_ptr_14 = getelementptr inbounds [36 x i8], ptr @.cname.14, i64 0, i64 0
