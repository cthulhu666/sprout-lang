...
@.str.21 = private unnamed_addr constant { i64, [2 x i8] } { i64 16394, [2 x i8] c"\0D\00" }
@.str.22 = private unnamed_addr constant { i64, [11 x i8] } { i64 163850, [11 x i8] c"0123456789\00" }
@.str.23 = private unnamed_addr constant { i64, [13 x i8] } { i64 196618, [13 x i8] c"do:io-result\00" }
@.str.24 = private unnamed_addr constant { i64, [23 x i8] } { i64 360458, [23 x i8] c"capturing payload size\00" }
@.str.25 = private unnamed_addr constant { i64, [13 x i8] } { i64 196618, [13 x i8] c"io-do:bytes=\00" }
@.str.26 = private unnamed_addr constant { i64, [19 x i8] } { i64 294922, [19 x i8] c"io-do:crypto-error\00" }
...
@.str.66 = private unnamed_addr constant { i64, [13 x i8] } { i64 196618, [13 x i8] c"do:io-result\00" }
@.str.67 = private unnamed_addr constant { i64, [23 x i8] } { i64 360458, [23 x i8] c"capturing payload size\00" }
...
entry:
  ...
  %t$1 = getelementptr inbounds { i64, [1 x i8] }, ptr @.str.15, i64 0, i32 1, i64 0
...
entry:
  ...
  br i1 %t$11, label %then_3, label %else_3
then_3:
  %t$5 = getelementptr inbounds { i64, [1 x i8] }, ptr @.str.20, i64 0, i32 1, i64 0
  %t$6 = ptrtoint ptr %t$5 to i64
  br label %join_3
else_3:
  %t$7 = add i64 0, 1
...
entry:
  %t$0 = getelementptr inbounds { i64, [11 x i8] }, ptr @.str.22, i64 0, i32 1, i64 0
  %t$1 = ptrtoint ptr %t$0 to i64
  %t$4 = alloca i64
  store i64 %t$1, ptr %t$4
  %t$5 = call i64 @sprout_gc_push_i64_root(ptr %t$4)
...
entry:
  %t$0 = getelementptr inbounds { i64, [13 x i8] }, ptr @.str.23, i64 0, i32 1, i64 0
  %t$1 = ptrtoint ptr %t$0 to i64
  %t$2$ptr = inttoptr i64 %t$1 to ptr
  %t$2 = call i64 @print_str(ptr %t$2$ptr)
  %t$3 = getelementptr inbounds { i64, [23 x i8] }, ptr @.str.24, i64 0, i32 1, i64 0
...
do_short_9:
  ...
  store i64 %t$8, ptr %t$16
  %t$17 = call i64 @sprout_gc_push_i64_root(ptr %t$16)
  %t$12 = call i64 @sprout_make1(i64 %t$11, i64 %t$8)
  %t$18 = call i64 @sprout_gc_pop_roots(i64 1)
  br label %do_done_9
do_cont_9:
  %t$19 = alloca i64
  ...
  %t$21 = call i64 @sprout_gc_pop_roots(i64 1)
  %t$14 = call i64 @sprout_make1(i64 7, i64 %t$13)
  br label %do_done_9
do_done_9:
...
arm_0_2:
  ...
  br i1 %t$5, label %body_0_2, label %arm_1_2
body_0_2:
  %t$6 = getelementptr inbounds { i64, [13 x i8] }, ptr @.str.25, i64 0, i32 1, i64 0
...
arm_1_2:
  ...
  br i1 %t$12, label %body_1_2, label %arm_2_2
body_1_2:
  %t$13 = getelementptr inbounds { i64, [19 x i8] }, ptr @.str.26, i64 0, i32 1, i64 0
...
entry:
  %t$0 = getelementptr inbounds { i64, [13 x i8] }, ptr @.str.66, i64 0, i32 1, i64 0
  %t$1 = ptrtoint ptr %t$0 to i64
  %t$2$ptr = inttoptr i64 %t$1 to ptr
  %t$2 = call i64 @print_str(ptr %t$2$ptr)
  %t$3 = getelementptr inbounds { i64, [23 x i8] }, ptr @.str.67, i64 0, i32 1, i64 0
  %t$4 = ptrtoint ptr %t$3 to i64
  %t$5$ptr = inttoptr i64 %t$4 to ptr
  %t$5 = call i64 @print_str(ptr %t$5$ptr)
  %t$6 = add i64 0, 8
