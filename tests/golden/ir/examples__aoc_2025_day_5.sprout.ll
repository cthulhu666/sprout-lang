...
define i64 @__sprout_ir_eta_range_start_0(i64 %env$, i64 %a0) {
entry:
  %ret = call i64 @range_start(i64 %a0)
  ret i64 %ret
}

define i64 @__sprout_ir_eta___tc_Ord_Int_compare_1(i64 %env$, i64 %a0, i64 %a1) {
entry:
  %ret = call i64 @__tc_Ord_Int_compare(i64 %a0, i64 %a1)
  ret i64 %ret
}

define i64 @__sprout_ir_eta___tc_Eq_Int_eq_2(i64 %env$, i64 %a0, i64 %a1) {
entry:
