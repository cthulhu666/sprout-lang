...
define i64 @__sprout_ir_eta_range_start_22(i64 %env$, i64 %a0) {
entry:
  %ret = call i64 @range_start(i64 %a0)
  ret i64 %ret
}

define i64 @__sprout_ir_eta___tc_Ord_Int_compare_23(i64 %env$, i64 %a0, i64 %a1) {
entry:
  %ret = call i64 @__tc_Ord_Int_compare(i64 %a0, i64 %a1)
  ret i64 %ret
}

define i64 @__sprout_ir_eta___tc_Eq_Int_eq_24(i64 %env$, i64 %a0, i64 %a1) {
entry:
...
entry:
  ...
  %t$0 = call i64 @sprout_alloc_closure(i64 8, i64 1)
  %t$0$raw = inttoptr i64 %t$0 to ptr
  store ptr @__sprout_ir_eta_range_start_22, ptr %t$0$raw
  %t$13 = alloca i64
  store i64 %t$0, ptr %t$13
  %t$14 = call i64 @sprout_gc_push_i64_root(ptr %t$13)
  %t$1 = call i64 @sprout_alloc_closure(i64 8, i64 2)
  %t$1$raw = inttoptr i64 %t$1 to ptr
  store ptr @__sprout_ir_eta___tc_Ord_Int_compare_23, ptr %t$1$raw
  %t$15 = alloca i64
  store i64 %t$1, ptr %t$15
  %t$16 = call i64 @sprout_gc_push_i64_root(ptr %t$15)
  %t$2 = call i64 @sprout_alloc_closure(i64 8, i64 2)
  %t$2$raw = inttoptr i64 %t$2 to ptr
  store ptr @__sprout_ir_eta___tc_Eq_Int_eq_24, ptr %t$2$raw
  %t$17 = alloca i64
  store i64 %t$2, ptr %t$17
  %t$18 = call i64 @sprout_gc_push_i64_root(ptr %t$17)
