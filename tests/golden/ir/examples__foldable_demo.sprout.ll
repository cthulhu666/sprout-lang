...
@.str.1 = private unnamed_addr constant { i64, [40 x i8] } { i64 638986, [40 x i8] c"Int overflow in + (line 368, column 85)\00" }
...
ovfpanic_18:
  %t$19 = getelementptr inbounds { i64, [40 x i8] }, ptr @.str.1, i64 0, i32 1, i64 0
...
define i64 @examples.foldable_demo.list_to_vec(i64 %p$xs, i64 %p$__tc_Foldable_0_fold_values, i64 %p$__tc_Foldable_0_fold_while_values) {
entry:
  %t$1 = alloca i64
  store i64 %p$xs, ptr %t$1
  %t$2 = call i64 @sprout_gc_push_i64_root(ptr %t$1)
  %t$3 = alloca i64
  store i64 %p$__tc_Foldable_0_fold_while_values, ptr %t$3
  %t$4 = call i64 @sprout_gc_push_i64_root(ptr %t$3)
  %t$5 = alloca i64
  store i64 %p$__tc_Foldable_0_fold_values, ptr %t$5
  %t$6 = call i64 @sprout_gc_push_i64_root(ptr %t$5)
  %t$0 = call i64 @foldable_to_vec(i64 %p$xs, i64 %p$__tc_Foldable_0_fold_values, i64 %p$__tc_Foldable_0_fold_while_values)
  %t$7 = call i64 @sprout_gc_pop_roots(i64 3)
  ret i64 %t$0
}

define i64 @examples.foldable_demo.vec_to_vec(i64 %p$xs, i64 %p$__tc_Foldable_0_fold_values, i64 %p$__tc_Foldable_0_fold_while_values) {
entry:
  %t$1 = alloca i64
  store i64 %p$xs, ptr %t$1
  %t$2 = call i64 @sprout_gc_push_i64_root(ptr %t$1)
...
define i64 @__sprout_ir_eta___tc_Foldable_List_fold_values_1(i64 %p$env$, i64 %p$a0, i64 %p$a1, i64 %p$a2) {
entry:
  %t$0 = alloca i64
...
define i64 @__sprout_ir_eta___tc_Foldable_List_fold_while_values_2(i64 %p$env$, i64 %p$a0, i64 %p$a1, i64 %p$a2, i64 %p$a3) {
entry:
  %t$0 = alloca i64
...
define i64 @__sprout_ir_eta___tc_Foldable_Vec_fold_values_3(i64 %p$env$, i64 %p$a0, i64 %p$a1, i64 %p$a2) {
entry:
  %t$0 = alloca i64
  store i64 %p$a2, ptr %t$0
  %t$1 = call i64 @sprout_gc_push_i64_root(ptr %t$0)
...
define i64 @__sprout_ir_eta___tc_Foldable_Vec_fold_while_values_4(i64 %p$env$, i64 %p$a0, i64 %p$a1, i64 %p$a2, i64 %p$a3) {
entry:
  %t$0 = alloca i64
  store i64 %p$a3, ptr %t$0
  %t$1 = call i64 @sprout_gc_push_i64_root(ptr %t$0)
...
entry:
  ...
  store ptr @__sprout_ir_eta___tc_Foldable_List_fold_while_values_2, ptr %t$2$raw
  %t$18 = alloca i64
  store i64 %t$2, ptr %t$18
  %t$19 = call i64 @sprout_gc_push_i64_root(ptr %t$18)
  %t$3 = call i64 @examples.foldable_demo.list_to_vec(i64 %t$0, i64 %t$1, i64 %t$2)
  %t$20 = call i64 @sprout_gc_pop_roots(i64 3)
  %t$4 = call i64 @vec_length(i64 %t$3)
  %t$5 = call i64 @examples.foldable_demo.vec_sample()
  %t$21 = alloca i64
  store i64 %t$5, ptr %t$21
  %t$22 = call i64 @sprout_gc_push_i64_root(ptr %t$21)
  %t$6 = call i64 @sprout_alloc_closure(i64 8, i64 3)
  %t$6$raw = inttoptr i64 %t$6 to ptr
  store ptr @__sprout_ir_eta___tc_Foldable_Vec_fold_values_3, ptr %t$6$raw
  %t$23 = alloca i64
  store i64 %t$6, ptr %t$23
  %t$24 = call i64 @sprout_gc_push_i64_root(ptr %t$23)
  %t$7 = call i64 @sprout_alloc_closure(i64 8, i64 4)
  %t$7$raw = inttoptr i64 %t$7 to ptr
  store ptr @__sprout_ir_eta___tc_Foldable_Vec_fold_while_values_4, ptr %t$7$raw
  %t$25 = alloca i64
  store i64 %t$7, ptr %t$25
  %t$26 = call i64 @sprout_gc_push_i64_root(ptr %t$25)
  %t$8 = call i64 @examples.foldable_demo.vec_to_vec(i64 %t$5, i64 %t$6, i64 %t$7)
  %t$27 = call i64 @sprout_gc_pop_roots(i64 3)
  %t$9 = call i64 @vec_length(i64 %t$8)
...
ovfpanic_10:
  ...
  unreachable
ovfok_10:
  %t$13 = call i64 @print_value(i64 %t$10)
  ret i64 %t$13
}
