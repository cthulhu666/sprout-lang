...
@.str.0 = private unnamed_addr constant { i64, [39 x i8] } { i64 622602, [39 x i8] c"Int overflow in + (line 10, column 27)\00" }
...
entry:
  ...
  store ptr @__sprout_ir_eta_$entry.inc_0, ptr %t$0$raw
  %t$1 = add i64 0, 2
  %t$5 = alloca i64
