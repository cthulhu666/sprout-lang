...
define i64 @__sprout_ir_eta_examples.aoc_2025_day_4.is_non_empty_line_22(i64 %env$, i64 %a0) {
entry:
  %t$0 = alloca i64
...
entry:
  ...
  %t$0 = call i64 @sprout_alloc_closure(i64 8, i64 1)
  %t$0$raw = inttoptr i64 %t$0 to ptr
  store ptr @__sprout_ir_eta_examples.aoc_2025_day_4.is_non_empty_line_22, ptr %t$0$raw
  %t$5 = alloca i64
  store i64 %t$0, ptr %t$5
  %t$6 = call i64 @sprout_gc_push_i64_root(ptr %t$5)
