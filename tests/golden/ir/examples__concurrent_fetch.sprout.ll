...
@.str.28 = private unnamed_addr constant { i64, [15 x i8] } { i64 229386, [15 x i8] c" ...requesting\00" }
@.str.29 = private unnamed_addr constant { i64, [9 x i8] } { i64 131082, [9 x i8] c" ...done\00" }
@.str.30 = private unnamed_addr constant { i64, [5 x i8] } { i64 65546, [5 x i8] c": ok\00" }
@.str.31 = private unnamed_addr constant { i64, [6 x i8] } { i64 81930, [6 x i8] c"users\00" }
@.str.32 = private unnamed_addr constant { i64, [6 x i8] } { i64 81930, [6 x i8] c"prefs\00" }
@.str.33 = private unnamed_addr constant { i64, [10 x i8] } { i64 147466, [10 x i8] c"inventory\00" }
@.str.34 = private unnamed_addr constant { i64, [4 x i8] } { i64 49162, [4 x i8] c" | \00" }
@.str.35 = private unnamed_addr constant { i64, [4 x i8] } { i64 49162, [4 x i8] c" | \00" }
@.str.36 = private unnamed_addr constant { i64, [19 x i8] } { i64 294922, [19 x i8] c"dashboard loaded: \00" }
...
@.str.80 = private unnamed_addr constant { i64, [17 x i8] } { i64 262154, [17 x i8] c"0123456789abcdef\00" }
...
arm_1_1:
  ...
  br i1 %t$7, label %body_1_1, label %arm_2_1
body_1_1:
  %t$8 = call i64 @sprout_alloc_obj(i64 20, i64 0)
  br label %join_1
arm_2_1:
  %t$9 = call i64 @sprout_alloc_obj(i64 18, i64 0)
  br label %join_1
arm_3_1:
  call void @sprout_abort_match()
  unreachable
...
define i64 @__sprout_ir_lambda_25(i64 %env$, i64 %s) {
entry:
  %t$0$env_ptr = inttoptr i64 %env$ to ptr
  %t$0$slot_ptr = getelementptr i64, ptr %t$0$env_ptr, i64 1
  %t$0 = load i64, ptr %t$0$slot_ptr
...
else_3:
  ...
  store ptr @__sprout_ir_lambda_25, ptr %t$6$raw
...
then_0:
  ...
  br label %join_0
else_0:
  %t$3 = call i64 @sprout_alloc_obj(i64 17, i64 0)
  br label %join_0
join_0:
...
define i64 @__sprout_ir_lambda_26(i64 %env$, i64 %acc, i64 %s) {
entry:
  %t$0$env_ptr = inttoptr i64 %env$ to ptr
  %t$0$slot_ptr = getelementptr i64, ptr %t$0$env_ptr, i64 1
  %t$0 = load i64, ptr %t$0$slot_ptr
...
entry:
  %t$0 = getelementptr inbounds { i64, [15 x i8] }, ptr @.str.28, i64 0, i32 1, i64 0
  %t$1 = ptrtoint ptr %t$0 to i64
  %t$12 = alloca i64
  ...
  %t$4 = call i64 @stdlib.task.task_sleep(i64 %latency_ms)
  %t$5 = getelementptr inbounds { i64, [9 x i8] }, ptr @.str.29, i64 0, i32 1, i64 0
  %t$6 = ptrtoint ptr %t$5 to i64
  %t$17 = alloca i64
  ...
  %t$9 = getelementptr inbounds { i64, [5 x i8] }, ptr @.str.30, i64 0, i32 1, i64 0
  %t$10 = ptrtoint ptr %t$9 to i64
  %t$20 = alloca i64
  store i64 %t$10, ptr %t$20
  %t$21 = call i64 @sprout_gc_push_i64_root(ptr %t$20)
  %t$11 = call i64 @stdlib.string.concat(i64 %name, i64 %t$10)
  %t$22 = call i64 @sprout_gc_pop_roots(i64 2)
  ret i64 %t$11
}

define i64 @__sprout_ir_lambda_27(i64 %env$, i64 %_) {
entry:
  %t$0 = getelementptr inbounds { i64, [6 x i8] }, ptr @.str.31, i64 0, i32 1, i64 0
  %t$1 = ptrtoint ptr %t$0 to i64
  %t$2 = add i64 0, 30
  %t$4 = alloca i64
  store i64 %t$1, ptr %t$4
...
entry:
  %t$0 = getelementptr inbounds { i64, [6 x i8] }, ptr @.str.32, i64 0, i32 1, i64 0
  %t$1 = ptrtoint ptr %t$0 to i64
  %t$2 = add i64 0, 50
  %t$4 = alloca i64
  store i64 %t$1, ptr %t$4
...
entry:
  ...
  %t$20 = call i64 @sprout_gc_push_i64_root(ptr %t$19)
  %t$1 = call i64 @stdlib.task.task_fork(i64 %s, i64 %t$0)
  %t$21 = call i64 @sprout_gc_pop_roots(i64 1)
  %t$22 = alloca i64
  ...
  store ptr @__sprout_ir_lambda_28, ptr %t$2$raw
  %t$24 = alloca i64
  store i64 %t$2, ptr %t$24
  %t$25 = call i64 @sprout_gc_push_i64_root(ptr %t$24)
  %t$3 = call i64 @stdlib.task.task_fork(i64 %s, i64 %t$2)
  %t$26 = call i64 @sprout_gc_pop_roots(i64 1)
  %t$27 = alloca i64
  ...
  store ptr @__sprout_ir_lambda_29, ptr %t$4$raw
  %t$29 = alloca i64
  store i64 %t$4, ptr %t$29
  %t$30 = call i64 @sprout_gc_push_i64_root(ptr %t$29)
  %t$5 = call i64 @stdlib.task.task_fork(i64 %s, i64 %t$4)
  %t$31 = call i64 @sprout_gc_pop_roots(i64 1)
  %t$32 = alloca i64
  store i64 %t$5, ptr %t$32
  %t$33 = call i64 @sprout_gc_push_i64_root(ptr %t$32)
  %t$6 = call i64 @stdlib.task.task_await(i64 %t$1)
  %t$34 = alloca i64
  store i64 %t$6, ptr %t$34
  %t$35 = call i64 @sprout_gc_push_i64_root(ptr %t$34)
  %t$7 = call i64 @stdlib.task.task_await(i64 %t$3)
  %t$36 = alloca i64
  store i64 %t$7, ptr %t$36
  %t$37 = call i64 @sprout_gc_push_i64_root(ptr %t$36)
  %t$8 = call i64 @stdlib.task.task_await(i64 %t$5)
  %t$9 = getelementptr inbounds { i64, [4 x i8] }, ptr @.str.34, i64 0, i32 1, i64 0
  %t$10 = ptrtoint ptr %t$9 to i64
  %t$11 = getelementptr inbounds { i64, [4 x i8] }, ptr @.str.35, i64 0, i32 1, i64 0
  %t$12 = ptrtoint ptr %t$11 to i64
  %t$38 = alloca i64
  ...
  %t$43 = call i64 @sprout_gc_push_i64_root(ptr %t$42)
  %t$13 = call i64 @stdlib.string.concat(i64 %t$12, i64 %t$8)
  %t$44 = call i64 @sprout_gc_pop_roots(i64 1)
  %t$45 = alloca i64
  store i64 %t$13, ptr %t$45
  %t$46 = call i64 @sprout_gc_push_i64_root(ptr %t$45)
  %t$14 = call i64 @stdlib.string.concat(i64 %t$7, i64 %t$13)
  %t$47 = call i64 @sprout_gc_pop_roots(i64 1)
  %t$48 = alloca i64
  store i64 %t$14, ptr %t$48
  %t$49 = call i64 @sprout_gc_push_i64_root(ptr %t$48)
  %t$15 = call i64 @stdlib.string.concat(i64 %t$10, i64 %t$14)
...
define i64 @__sprout_ir_lambda_30(i64 %env$, i64 %s) {
entry:
  %t$1 = alloca i64
  store i64 %s, ptr %t$1
  %t$2 = call i64 @sprout_gc_push_i64_root(ptr %t$1)
...
entry:
  ...
  %t$8 = call i64 @sprout_gc_pop_roots(i64 1)
  %t$2 = getelementptr inbounds { i64, [19 x i8] }, ptr @.str.36, i64 0, i32 1, i64 0
  %t$3 = ptrtoint ptr %t$2 to i64
  %t$9 = alloca i64
  store i64 %t$1, ptr %t$9
  %t$10 = call i64 @sprout_gc_push_i64_root(ptr %t$9)
  ...
  %t$12 = call i64 @sprout_gc_push_i64_root(ptr %t$11)
  %t$4 = call i64 @stdlib.string.concat(i64 %t$3, i64 %t$1)
  %t$13 = call i64 @sprout_gc_pop_roots(i64 2)
...
entry:
  ...
  %t$36 = call i64 @sprout_gc_pop_roots(i64 2)
  %t$11 = getelementptr inbounds { i64, [3 x i8] }, ptr @.str.41, i64 0, i32 1, i64 0
  %t$12 = ptrtoint ptr %t$11 to i64
  %t$37 = alloca i64
  ...
  %t$46 = call i64 @sprout_gc_pop_roots(i64 3)
  %t$17 = getelementptr inbounds { i64, [2 x i8] }, ptr @.str.42, i64 0, i32 1, i64 0
...
entry:
  %t$0 = getelementptr inbounds { i64, [17 x i8] }, ptr @.str.80, i64 0, i32 1, i64 0
  %t$1 = ptrtoint ptr %t$0 to i64
  %t$25 = alloca i64
...
arm_1_5:
  ...
  br i1 %t$11, label %body_1_5, label %arm_2_5
body_1_5:
  %t$12 = getelementptr inbounds { i64, [17 x i8] }, ptr @.str.81, i64 0, i32 1, i64 0
  %t$13 = ptrtoint ptr %t$12 to i64
  %t$33 = alloca i64
  store i64 %t$13, ptr %t$33
  %t$34 = call i64 @sprout_gc_push_i64_root(ptr %t$33)
