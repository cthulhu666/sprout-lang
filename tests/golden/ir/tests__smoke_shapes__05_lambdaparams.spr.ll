...
define i64 @$entry.apply(i64 %f, i64 %x) {
entry:
  call void @sprout_closure_arity_check(i64 %f, i64 1)
  %t$0$env_ptr = inttoptr i64 %f to ptr
  %t$0$code = load ptr, ptr %t$0$env_ptr
...
define i64 @__sprout_ir_lambda_21(i64 %env$, i64 %n) {
entry:
  %t$0 = add i64 0, 1
  %t$1 = add i64 %n, %t$0
  ret i64 %t$1
...
define i64 @__sprout_ir_lambda_22(i64 %env$, i64 %n) {
entry:
  %t$0 = add i64 0, 2
  %t$1 = mul i64 %n, %t$0
  ret i64 %t$1
...
entry:
  ...
  %t$9 = call i64 @sprout_gc_push_i64_root(ptr %t$8)
  %t$3 = call i64 @$entry.apply(i64 %t$1, i64 %t$2)
  %t$10 = call i64 @sprout_gc_pop_roots(i64 1)
  %t$4 = call i64 @$entry.apply(i64 %t$0, i64 %t$3)
  %t$11 = call i64 @sprout_gc_pop_roots(i64 1)
