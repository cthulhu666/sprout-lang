...
@.str.10 = private unnamed_addr constant { i64, [18 x i8] } { i64 278538, [18 x i8] c"hello from sprout\00" }
...
entry:
  %t$0 = getelementptr inbounds { i64, [18 x i8] }, ptr @.str.10, i64 0, i32 1, i64 0
  %t$1 = ptrtoint ptr %t$0 to i64
