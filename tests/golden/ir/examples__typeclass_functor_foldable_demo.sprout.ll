...
entry:
  ...
  store ptr @__sprout_ir_eta_examples.typeclass_functor_foldable_demo.add_0, ptr %t$0$raw
  %t$1 = add i64 0, 0
  %t$11 = alloca i64
  ...
  store ptr @__sprout_ir_eta_examples.typeclass_functor_foldable_demo.add_one_1, ptr %t$2$raw
  %t$13 = alloca i64
...
define i64 @__sprout_ir_eta___tc_Functor_Vec_fmap_4(i64 %env$, i64 %a0, i64 %a1) {
entry:
  %t$0 = alloca i64
  store i64 %a1, ptr %t$0
  %t$1 = call i64 @sprout_gc_push_i64_root(ptr %t$0)
...
define i64 @__sprout_ir_eta___tc_Foldable_Vec_fold_values_5(i64 %env$, i64 %a0, i64 %a1, i64 %a2) {
entry:
  %t$0 = alloca i64
  store i64 %a2, ptr %t$0
  %t$1 = call i64 @sprout_gc_push_i64_root(ptr %t$0)
...
entry:
  ...
  store ptr @__sprout_ir_eta___tc_Functor_Vec_fmap_4, ptr %t$5$raw
  %t$19 = alloca i64
  store i64 %t$5, ptr %t$19
  %t$20 = call i64 @sprout_gc_push_i64_root(ptr %t$19)
  %t$6 = call i64 @sprout_alloc_closure(i64 8, i64 3)
  %t$6$raw = inttoptr i64 %t$6 to ptr
  store ptr @__sprout_ir_eta___tc_Foldable_Vec_fold_values_5, ptr %t$6$raw
  %t$21 = alloca i64
