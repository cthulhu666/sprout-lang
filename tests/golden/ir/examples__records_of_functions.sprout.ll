...
define i64 @__sprout_ir_lambda_22(i64 %env$, i64 %text) {
entry:
  %t$0$env_ptr = inttoptr i64 %env$ to ptr
  %t$0$slot_ptr = getelementptr i64, ptr %t$0$env_ptr, i64 1
  %t$0 = load i64, ptr %t$0$slot_ptr
...
define i64 @__sprout_ir_lambda_23(i64 %env$, i64 %text) {
entry:
  %t$0$env_ptr = inttoptr i64 %env$ to ptr
  %t$0$slot_ptr = getelementptr i64, ptr %t$0$env_ptr, i64 1
  %t$0 = load i64, ptr %t$0$slot_ptr
...
entry:
  ...
  %t$1$raw = inttoptr i64 %t$1 to ptr
  store ptr @__sprout_ir_lambda_23, ptr %t$1$raw
...
define i64 @__sprout_ir_lambda_24(i64 %env$, i64 %text) {
entry:
  %t$0$env_ptr = inttoptr i64 %env$ to ptr
  %t$0$slot_ptr = getelementptr i64, ptr %t$0$env_ptr, i64 1
  %t$0 = load i64, ptr %t$0$slot_ptr
...
define i64 @__sprout_ir_lambda_25(i64 %env$, i64 %text) {
entry:
  %t$0$env_ptr = inttoptr i64 %env$ to ptr
  %t$0$slot_ptr = getelementptr i64, ptr %t$0$env_ptr, i64 1
  %t$0 = load i64, ptr %t$0$slot_ptr
...
entry:
  ...
  %t$1 = call i64 @sprout_alloc_closure(i64 24, i64 1)
  %t$1$raw = inttoptr i64 %t$1 to ptr
  store ptr @__sprout_ir_lambda_25, ptr %t$1$raw
  %t$1$raw$slot$1 = getelementptr i64, ptr %t$1$raw, i64 1
...
define i64 @__sprout_ir_lambda_26(i64 %env$, i64 %named) {
entry:
