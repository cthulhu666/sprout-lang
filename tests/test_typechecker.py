...
class TypecheckerTests(unittest.TestCase):
    ...
    def test_builtin_effect_audit_snapshot(self) -> None:
        ...
        expected = {
            ...
            "regex_validate": "String -> Result String Unit",
            "regex_is_match": "String -> String -> Bool",
            "regex_find_range": "String -> String -> Maybe IntRange",
            "regex_replace_all_literal": "String -> String -> String -> String",
            ...
            "read_file": "String -> Result String String !{IO}",
            "write_file": "String -> String -> Result String Unit !{IO}",
