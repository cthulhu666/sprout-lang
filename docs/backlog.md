...
2. Align function application semantics across the spec, typechecker, interpreter, and native backend by deciding whether partial application belongs in v0 and then implementing that decision consistently.
