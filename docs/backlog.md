...
6. Continue native memory-management v1.
   ...
   Remaining v1 scope: extend the new shadow-root model across all live managed values, define normal mid-execution collection policy, and add stronger reclamation-focused validation.
