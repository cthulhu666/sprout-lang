...
6. Continue native memory-management v1.
   ...
   Remaining v1 scope: design a sound mid-execution root model, define normal mid-execution collection policy, and add stronger reclamation-focused validation.
