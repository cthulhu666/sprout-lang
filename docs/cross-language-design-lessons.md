...
| 2 | `String = [Char]` | ⚠️ | UTF-8 buffer (trap avoided) but length is **O(n)**, not O(1): `stdlib/string.sprout:11-17` |
...
**The three gaps in #2/#3/#9 were corrected in `haskell-lessons-learned.md` in the same change that
added this doc.** Items #11/#12/#13 are genuinely undecided and correctly hedged there.
