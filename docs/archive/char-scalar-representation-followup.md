...
`docs/archive/p11-over-rooting-handoff-2026-06-28.md`. The value that *did* land:
...
- Eliminates the entire "Char rooting" bug class at the root rather than paying
  ...
  (see `docs/archive/p11-over-rooting-handoff-2026-06-28.md`): fewer roots, not more.
