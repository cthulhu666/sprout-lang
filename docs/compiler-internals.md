...
- `just test-stress` sets it alongside `SPROUT_GC_STRESS=1`, which maximises the *number* of collections — but forces small heaps, where pass 2 barely releases a region.
